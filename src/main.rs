...
enum Command {
    ...
    Render {
        ...
        /// `auto`=工場リードはオクターブ上（薄いとき5度）。キラキラ／風系パッドは
        /// ±オクターブ（静的に1–3Hzずらしてうねり。薄いとき5度と+24＋ミッドBP）。工場FXの
        /// ピッチ系は −12/−24（薄いとき−36）。他の工場FXは−12。`none` /
        /// `octave,octave-down` / `octave-up-2,fifth` / `0,-12,12,24`。
